...
def main() -> None:
    ...
    # Prompt text is intentionally wrapped across source-code lines. Normalize
    # all whitespace before checking semantic clauses so harmless line breaks
    # do not cause false test failures.
    ...
    for clause in required_main_clauses:
        assert clause in normalized_prompt, clause
    ...
    for clause in required_verifier_clauses:
        assert clause in normalized_verifier_prompt, clause
