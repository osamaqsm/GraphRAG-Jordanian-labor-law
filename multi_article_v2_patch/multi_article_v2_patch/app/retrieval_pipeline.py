    ...
    def retrieve(
        ...
        *,
        ...
        if analysis.behavior == "retrieve":
            ...
            # Embed the original question and every atomic issue in one API
            # request. This preserves the global retrieval path while giving
            # each multi-issue component an independent semantic vector.
            embedding_inputs = [
                question,
                *(query for _, query in multi_issue_pairs),
            ]
