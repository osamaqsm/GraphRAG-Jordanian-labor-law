            ...
            for issue_index, (label, query) in enumerate(
                ...
                if support_number is None:
                    ...
                    for number in values:
                        if int(number) in ranked_by_number:
                            support_number = int(number)
                            source = "issue_retrieval_repair"
                            break
    ...
    def preview(
        ...
        *,
        ...
        for _label, issue_query, issue_vector in issue_query_vectors:
            issue_analysis = analyze_legal_question(issue_query)
            ...
            for hit in issue_ranked:
                ...
                if (
                    relevance >= ISSUE_COVERAGE_MIN_RELEVANCE
                    or hit.graph_supported
                ):
                    strong_issue_numbers.append(int(hit.article_number))
