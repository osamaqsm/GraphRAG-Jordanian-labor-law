...
│   ├── weaviate_db.py
│   ├── weaviate_schema.py
│   ├── weaviate_ingestion.py
│   ├── legal_question_analysis.py
│   ├── legal_query_planner.py
│   ├── legal_article_reranker.py
│   ├── graph_retrieval.py
│   ├── retrieval_service.py
│   ├── retrieval_pipeline.py
│   ├── retrieval_contract.py
│   └── grounded_answer_generator.py
│
├── scripts/
│   ├── ingest_kg.py
│   ├── inspect_ttl.py
...
│   ├── check_ingestion.py
│   ├── retrieve.py
│   ├── generate_from_retrieval.py
│   └── run_full_pipeline_evaluation.py
│
├── data/
│   ├── jordan_labor_law_full_knowledge_graph.ttl
│   ├── benchmarks/
│   │   ├── jordan_labor_law_fresh_final_40_v2_3.json
│   │   ├── jordan_labor_law_fresh_final_40_v2_3.sha256.txt
│   │   └── jordan_labor_law_fresh_final_40_v2_3_validation_report.md
│   └── model_evaluations/
│       └── fresh_final_v2_3/
│           ├── openai__gpt-5-nano/
│           ├── google__gemini-3.5-flash-lite/
│           ├── opencode__qwen3.7-plus/
│           └── cohere__c4ai-aya-expanse-32b/
│
├── Dockerfile
├── docker-compose.yml
├── requirements.txt
